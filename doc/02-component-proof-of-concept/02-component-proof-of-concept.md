...
My choice of design is the first component which deals with the satellite tracker. I brainstormed all three components with three criteria in mind: (1) interest, (2) value and (3) impact. By interest, I mean my personal interest in that area. Space and Astronomy has always been something that has fascinated me to the point where I have done a research internship in astrophysics during my high school career to learn more about the field. It was during this time I realized the pressing need for fluency in computational tools to use those tools in Astronomy which will make life (and doing science) much easier. Therefore, I chose to major in Data Analytics as its a versatile field with a flexibility to dive into astrophysics if I wished to do so as well as just explore any fields. This is also the reason why I designed this component as it provides an easy way to track the numerous objects in space which is also raising the concern of space debris.  By value, I mean that my component needs to have a tangible impact and usefulness for some groups. I hope that this tracker provides a way to keep record of data and retrieve and manipulate them to perform some low level data analysis as needed. Furthermore, I believe having a tracker will help in research of tackling the space debris problem. However, I am not sure how I will sell this to employers or even if employers will find this component impactful. Therefore, I might switch my choice of design later to make it more convincing for employers such that it has more impact -- I am not sure and I would like to get some advice regarding this.
